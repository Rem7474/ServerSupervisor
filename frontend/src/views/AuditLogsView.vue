  ...
  <div>
    <div class="page-header d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
      ...
      <div class="d-flex align-items-center gap-2">
        <button class="btn btn-outline-secondary" @click="refresh" :disabled="loading || connexionsLoading || cmdsLoading">Actualiser</button>
      </div>
    </div>
    ...
    <div v-show="activeTab === 'logs'">
      <div class="card">
        ...
        <div class="card-footer d-flex align-items-center justify-content-between">
          ...
          <div class="btn-group">
            <button class="btn btn-outline-secondary" @click="prevPage" :disabled="page <= 1 || loading">Précédent</button>
...
function refresh() {
  if (activeTab.value === 'logs') {
    fetchLogs()
  } else if (activeTab.value === 'commandes') {
