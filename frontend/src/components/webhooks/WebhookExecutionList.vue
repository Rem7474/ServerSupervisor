          ...
          >
            <template v-if="kind === 'tracker'">
              ...
              <td class="small">
                <div>
                  <a
                    v-if="execution.release_url"
                    :href="execution.release_url"
                    target="_blank"
                    class="link-primary fw-semibold"
                  >{{ execution.tag_name || '—' }}</a>
                  <span
                    v-else
                    class="fw-semibold"
                  >{{ execution.tag_name || '—' }}</span>
                </div>
                <div
                  v-if="execution.release_name && execution.release_name !== execution.tag_name"
            ...
            <template v-else>
              ...
              <td class="small">
                <div
                  ...
                  :title="execution.repo_name"
                >
                  {{ execution.repo_name || execution.sourceName || '—' }}
                </div>
              ...
              <td class="small">
                ...
                <div
                  ...
                  :title="execution.commit_message"
                >
